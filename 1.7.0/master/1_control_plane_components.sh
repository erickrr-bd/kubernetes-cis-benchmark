...
check_1_1_13="1.1.13  - Ensure that the admin.conf file permissions are set to 600 (Automated)"
...
check_1_2_3="1.2.3 - Ensure that the --DenyServiceExternalIPs is not set (Automated)"
...
check_1_2_12="1.2.12  - Ensure that the admission control plugin SecurityContextDeny is set if PodSecurityPolicy is not used (Manual)"
...
check_1_2_13="1.2.13  - Ensure that the admission control plugin ServiceAccount is set (Automated)"
...
check_1_2_14="1.2.14  - Ensure that the admission control plugin NamespaceLifecycle is set (Automated)"
...
check_1_2_15="1.2.15  - Ensure that the admission control plugin NodeRestriction is set (Automated)"
...
check_1_2_17="1.2.17  - Ensure that the --profiling argument is set to false (Automated)"
...
check_1_2_18="1.2.18  - Ensure that the --audit-log-path argument is set (Automated)"
...
check_1_2_19="1.2.19  - Ensure that the --audit-log-maxage argument is set to 30 or as appropriate (Automated)"
...
check_1_2_20="1.2.20  - Ensure that the --audit-log-maxbackup argument is set to 10 or as appropriate (Automated)"
...
check_1_2_21="1.2.21  - Ensure that the --audit-log-maxsize argument is set to 100 or as appropriate (Automated)"
...
check_1_2_22="1.2.22  - Ensure that the --request-timeout argument is set as appropriate (Automated)"
...
check_1_2_23="1.2.23  - Ensure that the --service-account-lookup argument is set to true (Automated)"
...
check_1_2_24="1.2.24  - Ensure that the --service-account-key-file argument is set as appropriate (Automated)"
...
check_1_2_25="1.2.25  - Ensure that the --etcd-certfile and --etcd-keyfile arguments are set as appropriate (Automated)"
...
check_1_2_26="1.2.26  - Ensure that the --tls-cert-file and --tls-private-key-file arguments are set as appropriate (Automated)"
...
check_1_2_27="1.2.27  - Ensure that the --client-ca-file argument is set as appropriate (Automated)"
...
check_1_2_28="1.2.28  - Ensure that the --etcd-cafile argument is set as appropriate (Automated)"
...
check_1_2_29="1.2.29  - Ensure that the --encryption-provider-config argument is set as appropriate (Manual)"
...
check_1_2_30="1.2.30  - Ensure that encryption providers are appropriately configured (Manual)"
...
check_1_2_31="1.2.31  - Ensure that the API Server only makes use of Strong Cryptographic Ciphers (Manual)"
